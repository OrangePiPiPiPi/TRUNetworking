...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/fankai/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'fankai' => 'fank@izkml.com' }
  s.source           = { :git => 'https://github.com/fankai/TRUNetworking.git', :tag => s.version.to_s }
